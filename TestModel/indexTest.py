...
# Test model phiên bản tính toán thêm hiệu năng
# CreatedBy: PQ Huy
...
# load model
model = model_from_json(open("../model/ferTest.json", "r").read())

# load weights
model.load_weights('../model/ferTest.h5')

# detec face
face_haar_cascade = cv2.CascadeClassifier(cv2.data.haarcascades + "haarcascade_frontalface_default.xml")

# cap = cv2.VideoCapture(0)  # bật webcam
cap = cv2.VideoCapture("nckh1.png", cv2.CAP_IMAGES)
